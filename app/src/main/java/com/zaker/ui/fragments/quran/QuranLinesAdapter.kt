...
import com.zaker.R
import com.zaker.SuraNameUtil
import com.zaker.data.entities.model.QuranVersesEntity
import com.zaker.databinding.QuranItemBinding
        ...
        fun onBind(entities: List<QuranVersesEntity>) {
            ...
            entities.forEach {
                ...
                text.setOnLongClickListener {
                    onLongClick.invoke(com.zaker.common.Constants.LONGCLICK,text.contentDescription.toString(),
                        "${suraNumber.toString()}+${ayahNumberInSura.toString()}-${pageNumber.toString()}")

                }
                text.setOnClickListener {
                    onClick.invoke(com.zaker.common.Constants.ONCLICK)
                }
